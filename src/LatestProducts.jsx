       ...
       return(
           <>
            ...
            <div style={{padding:"5px",margin:"30px 0px"}}>
                <h1 style={{textAlign:"center",fontWeight:"bold"}}>Our Latest Products</h1>
              ...
              <div>
               ...
               <div className="card-body">
                 ...
                 <p className="card-price">₹{limitpro.price}</p>
                  ...
                  <button className="card-button" onClick={() => toggleCart(limitpro.id)}> {isInCart(limitpro.id) ? "Remove" : "Add to Cart"} 
              </button>
             </div>
             </div>
             </div>
